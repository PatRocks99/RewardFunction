...
ALGORITHMS = {
    ...
    "awac_bc_like": {
        "trainer": ROOT / "Controllers" / "AWAC" / "train_awac.py",
        "module": "matrix_train_awac_bc_like",
        "base": {
            "batch_size": 256,
            "actor_lr": 3e-4,
            "critic_lr": 3e-4,
        ...
        "search": [
            {"awac_lambda": 3.0, "max_weight": 3.0},
            {"awac_lambda": 5.0, "max_weight": 5.0},
            {"awac_lambda": 10.0, "max_weight": 5.0},
            {"awac_lambda": 10.0, "max_weight": 10.0},
        ],
    },
    "awac_aggressive": {
        "trainer": ROOT / "Controllers" / "AWAC" / "train_awac.py",
        "module": "matrix_train_awac_aggressive",
        "base": {
            "batch_size": 256,
            "actor_lr": 3e-4,
            "critic_lr": 3e-4,
        ...
        "search": [
            {"awac_lambda": 0.2, "max_weight": 20.0},
            {"awac_lambda": 0.3, "max_weight": 50.0},
            {"awac_lambda": 0.5, "max_weight": 50.0},
            {"awac_lambda": 0.5, "max_weight": 100.0},
        ],
    },
    "iql": {
