# %%
"""
AWAC percent-notebook.

Run cells top-to-bottom in VS Code, or run this file directly:

    python 6_Split_Data_Better_Steering/training_notebooks/train_awac_percent.py
"""
...
trainer = import_trainer(
    "percent_notebook_train_awac",
    ROOT / "Controllers" / "AWAC" / "train_awac.py",
)
